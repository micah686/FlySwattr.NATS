...
public class EnterpriseNatsOptions
{
    ...
    /// <summary>
    /// Hard-fail the host startup if NATS is unreachable.
    /// When enabled, a startup check pings NATS and throws on failure, preventing the host from starting.
    /// When disabled (default), the host starts normally and connects to NATS lazily.
    /// Default: false
    /// </summary>
